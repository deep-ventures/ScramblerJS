  ...
  var textNodesUnder = function(el) {
    ...
    function Scrambler() {
      ...
      var _scrambler = {
        ...
        _initCTA: function(locale, assetsPrefix) {

          var copyURL = (assetsPrefix || '') + 'assets/data/copy.json';
          var dialogURL = (assetsPrefix || '') + 'assets/partials/dialog.html';

          // load copy deck
          $.get(copyURL, function(data) {
        ...
        showCTA: function(locale, assetsPrefix) {
          $.when()
          .then(function() {
            _scrambler._initCTA(locale, assetsPrefix);
          })
      ...
      return {
        ...
        scramble: function(element, showCTA, assetsPrefix) {
          ...
          if (showCTA) {
            this.showCTA(_defaultLocale, assetsPrefix);
          }
          return this;
        },
        ...
        showCTA: function(locale, assetsPrefix) {
          ...
          _scrambler.showCTA(locale, assetsPrefix);
          return this;
        },

        go: function(locale, assetsPrefix, element) {
          ...
          console.log('[Scrambler] go', locale, element, assetsPrefix);
          this.scramble(element, true, assetsPrefix);
